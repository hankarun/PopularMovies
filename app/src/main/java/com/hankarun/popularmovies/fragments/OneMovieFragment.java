...
public class OneMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMovie = activity.mMovie;

        View rootView = inflater.inflate(R.layout.fragment_main2, container, false);

        mImageView = (ImageView) rootView.findViewById(R.id.posterImageView);
        mRatingView = (TextView) rootView.findViewById(R.id.ratingTextView);
        mReleaseDate = (TextView) rootView.findViewById(R.id.releaseDateViewText);
        mOverview = (WebView) rootView.findViewById(R.id.overViewWebView);
